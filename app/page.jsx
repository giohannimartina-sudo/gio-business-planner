...
export default function Home() {
  const enhancePlanner = useCallback((event) => {
    ...
    projectArchive.src='/gio-project-archive.js?v=024';
    ...
    analyticsPro.src='/gio-analytics-pro.js?v=024';
    ...
    remindersPro.src = '/gio-reminders-pro.js?v=024';
