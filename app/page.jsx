...
export default function Home() {
  const enhancePlanner = useCallback((event) => {
    ...
    projectArchive.src='/gio-project-archive.js?v=034a';
    ...
    analyticsPro.src='/gio-analytics-pro.js?v=034a';
    ...
    liveReady.src='/gio-live-readiness-pro.js?v=034a';
    ...
    paymentsPro.src='/gio-payments-pro.js?v=034a';
    ...
    brandingPro.src='/gio-branding-studio-pro.js?v=034a';
    ...
    todoAppointmentsPro.src='/gio-todo-appointments-pro.js?v=034a';
    ...
    cloudPro.src='/gio-cloud-sync-pro.js?v=034a';
    cloudPro.defer=true;
