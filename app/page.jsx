...
export default function Home() {
  const enhancePlanner = useCallback((event) => {
    ...
    projectArchive.src='/gio-project-archive.js?v=026c';
    ...
    analyticsPro.src='/gio-analytics-pro.js?v=026c';
    ...
    cloudPro.src='/gio-cloud-sync-pro.js?v=026c';
    cloudPro.defer=true;
