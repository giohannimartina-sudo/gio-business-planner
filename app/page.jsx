...
export default function Home() {
  const enhancePlanner = useCallback((event) => {
    ...
    css.rel = 'stylesheet';
    css.href = '/gio-mobile-approved.css?v=032';
    doc.head.appendChild(css);

    const script = doc.createElement('script');
    script.id = 'gio-approved-js';
    script.src = '/gio-mobile-approved.js?v=032';
    script.defer = true;
    doc.body.appendChild(script);

    const trips = doc.createElement('script');
    trips.id = 'gio-trips-js';
    trips.src = '/gio-trips-pro.js?v=032';
    trips.defer = true;
    ...
    window.setTimeout(() => {
      if (doc.getElementById('gio-agenda-vertical-pro-js')) return;
      const css = doc.createElement('link');
      css.id = 'gio-agenda-vertical-pro-css';
      css.rel = 'stylesheet';
      css.href = '/gio-agenda-vertical-pro.css?v=001';
      doc.head.appendChild(css);

      const agenda = doc.createElement('script');
      agenda.id = 'gio-agenda-vertical-pro-js';
