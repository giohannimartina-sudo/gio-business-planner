...
export default function Home() {
  const enhancePlanner = useCallback((event) => {
    ...
    projectArchive.src='/gio-project-archive.js?v=029';
    ...
    analyticsPro.src='/gio-analytics-pro.js?v=029';
    ...
    liveReady.src='/gio-live-readiness-pro.js?v=029';
    ...
    cloudPro.src='/gio-cloud-sync-pro.js?v=029';
    cloudPro.defer=true;
