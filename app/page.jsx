...
export default function Home() {
  const enhancePlanner = useCallback((event) => {
    ...
    projectArchive.src='/gio-project-archive.js?v=026b';
    ...
    analyticsPro.src='/gio-analytics-pro.js?v=026b';
    ...
    cloudPro.src='/gio-cloud-sync-pro.js?v=026b';
    cloudPro.defer=true;
