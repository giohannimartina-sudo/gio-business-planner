...
export default function Home() {
  const enhancePlanner = useCallback((event) => {
    ...
    projectArchive.src='/gio-project-archive.js?v=030';
    ...
    analyticsPro.src='/gio-analytics-pro.js?v=030';
    ...
    liveReady.src='/gio-live-readiness-pro.js?v=030';
    ...
    paymentsPro.src='/gio-payments-pro.js?v=030';
    ...
    cloudPro.src='/gio-cloud-sync-pro.js?v=030';
    cloudPro.defer=true;
