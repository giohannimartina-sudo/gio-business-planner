...
export default function Home() {
  const enhancePlanner = useCallback((event) => {
    ...
    projectArchive.src='/gio-project-archive.js?v=031';
    ...
    analyticsPro.src='/gio-analytics-pro.js?v=031';
    ...
    liveReady.src='/gio-live-readiness-pro.js?v=031';
    ...
    paymentsPro.src='/gio-payments-pro.js?v=031';
    ...
    cloudPro.src='/gio-cloud-sync-pro.js?v=031';
    cloudPro.defer=true;
