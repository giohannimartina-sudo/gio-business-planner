...
export default function Home() {
  const enhancePlanner = useCallback((event) => {
    ...
    projectArchive.src='/gio-project-archive.js?v=034';
    ...
    analyticsPro.src='/gio-analytics-pro.js?v=034';
    ...
    liveReady.src='/gio-live-readiness-pro.js?v=034';
    ...
    paymentsPro.src='/gio-payments-pro.js?v=034';
    ...
    brandingPro.src='/gio-branding-studio-pro.js?v=034';
    ...
    todoAppointmentsPro.src='/gio-todo-appointments-pro.js?v=034';
    ...
    cloudPro.src='/gio-cloud-sync-pro.js?v=034';
    cloudPro.defer=true;
