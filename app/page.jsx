...
export default function Home() {
  const enhancePlanner = useCallback((event) => {
    ...
    projectArchive.src='/gio-project-archive.js?v=026a';
    ...
    analyticsPro.src='/gio-analytics-pro.js?v=026a';
    ...
    cloudPro.src='/gio-cloud-sync-pro.js?v=026a';
    cloudPro.defer=true;
