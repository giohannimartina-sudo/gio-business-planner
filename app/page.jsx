...
export default function Home() {
  const enhancePlanner = useCallback((event) => {
    ...
    projectArchive.src='/gio-project-archive.js?v=023';
    ...
    analyticsPro.src='/gio-analytics-pro.js?v=023';
