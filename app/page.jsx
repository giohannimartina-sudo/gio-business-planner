...
export default function Home() {
  const enhancePlanner = useCallback((event) => {
    ...
    projectArchive.src='/gio-project-archive.js?v=027';
    ...
    analyticsPro.src='/gio-analytics-pro.js?v=027';
    ...
    cloudPro.src='/gio-cloud-sync-pro.js?v=027';
    cloudPro.defer=true;
