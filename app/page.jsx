...
export default function Home() {
  const enhancePlanner = useCallback((event) => {
    ...
    projectArchive.src='/gio-project-archive.js?v=033';
    ...
    analyticsPro.src='/gio-analytics-pro.js?v=033';
    ...
    liveReady.src='/gio-live-readiness-pro.js?v=033';
    ...
    paymentsPro.src='/gio-payments-pro.js?v=033';
    ...
    brandingPro.src='/gio-branding-studio-pro.js?v=033';
    ...
    todoAppointmentsPro.src='/gio-todo-appointments-pro.js?v=033';
    ...
    cloudPro.src='/gio-cloud-sync-pro.js?v=033';
    cloudPro.defer=true;
