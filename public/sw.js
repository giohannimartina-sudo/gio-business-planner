const CACHE='gio-business-planner-mobile-workapp-v1';
const ASSETS=['/','/planner.html','/manifest.webmanifest','/gio-logo-192.png','/gio-logo-512.png','/favicon.png','/gio-v21-rc-testperiode.css','/gio-v21-rc-testperiode.js','/gio-mobile-workapp.css','/gio-mobile-workapp.js'];
